  ...
  <body data-spy="scroll" data-offset="0" data-target="#theMenu">
	...
	<nav class="menu" id="theMenu">
		<div class="menu-wrap">
			...
			<a href="${pageContext.request.contextPath }/memo/list.do#list" class="smoothScroll">메모목록</a>
			...
			<a href="${pageContext.request.contextPath }/bbs/list.do#list" class="smoothScroll">게시판목록</a>
			<a href="${pageContext.request.contextPath }/bbs/create.do#create" class="smoothScroll">게시판등록</a>
			<a href="${pageContext.request.contextPath }/team/list.do#list" class="smoothScroll">팀목록</a>
			<a href="${pageContext.request.contextPath }/team/create.do#create" class="smoothScroll">팀생성</a>
			<a href="${pageContext.request.contextPath }/imgbbs/list.do#list" class="smoothScroll">이미지목록</a>
